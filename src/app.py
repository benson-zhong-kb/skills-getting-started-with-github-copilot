...
activities = {
    ...
    "Soccer Club": {
        "description": "Develop soccer skills through drills and friendly matches",
    ...
    "Drama Club": {
        "description": "Learn acting, stagecraft, and prepare theatrical performances",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["amelia@mergington.edu", "noah@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build public speaking and critical thinking through debate",
